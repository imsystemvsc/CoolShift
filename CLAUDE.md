...
### Stack
- Language and version: C# (.NET 8.0 / net8.0-windows)
- Framework(s): WPF, CommunityToolkit.Mvvm
- Package manager: NuGet
- Runtime / deployment target: Windows (win-x64)
...
### Layout
- Source lives in: `./` (root directory and subdirectories `ViewModels/`, `Converters/`, `Monitoring/`, `Styles/`, `Resources/`)
- Tests live in: `TODO`
- Do not modify: `bin/`, `obj/`, `publish/` (build outputs)
